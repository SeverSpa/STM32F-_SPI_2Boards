...
In the Live watch field of the board we may see the Tx and Rx buffers as in the file https://github.com/SeverSpa/STM32F4_SPI_2Boards/blob/master/STM32F%24_SPI_2Boards/Screen1.png
